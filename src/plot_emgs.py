...
# load baseline EMG data and put them in two segments based on their state
baselineData = np.loadtxt("right_matchingtask_set01_trial09.txt")
# state1 = np.loadtxt("right_matchingtask_set01_trial09.txt")[:, [:, 1]==1]
