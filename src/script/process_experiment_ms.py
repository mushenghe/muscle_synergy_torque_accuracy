...
import numpy as np
from process_example_data import first_last_index, multiplication_update,process_state4_5
from plot_multiple import load_data,plot_baseline
...
if __name__ == "__main__":
    ...
    max_set = standard_process(max_set, baseline)
    ...
    SEG_STATE4,SEG_STATE5 = process_state4_5('/home/mushenghe/Desktop/final_project/data/Oct09/c01/Right/MatchingTask/Multi_Multi_El/',SET1_TRAILS,10,baseline,max_set)
